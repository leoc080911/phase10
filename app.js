...
const GENERIC_GAMES = [
  ...
  { id:'risk', name:'Risk (Risque)', icon:'ti-map', menuDesc:"Conquête de territoires, premier à 3 victoires remporte le match", roundLabel:'partie gagnée', win:'highest', target:3, allowNegative:false, calculatorValues:[1], playerWord:'Joueur',
    rules:[
      {t:"But du jeu", d:"Conquérir des territoires sur la carte du monde et éliminer les armées adverses pour dominer le plateau."},
      {t:"Une victoire", d:"Le joueur qui remplit l'objectif de la partie (domination ou mission secrète) la remporte (clique sur +1)."},
      {t:"Fin de match", d:"Jouez plusieurs parties ; le premier joueur à atteindre le nombre de victoires fixé gagne le match."}
    ]
  },
